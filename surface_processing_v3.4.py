...
##folder: /script_2
#v3.4 - added new "all_young" flag to be used for subjects younger than 28.5 weeks  (processes without subsampling)
...
def vol_meas():		
	...
	with open(input_fol+'/recon_segmentation/Volume_measures.txt', "w") as file:
		file.write(str(v1xScale)  + ' ' +  str(v2xScale) +  ' ' +  str(v3xScale) + ' ' +  str(v4xScale)+ "\n"  )
...
def main():
	...
	#renames folder to "recon_segmentation if not already renamed"
